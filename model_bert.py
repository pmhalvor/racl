...
class MODEL(object):
    ...
    def __init__(self, opt):
        with tf.name_scope('parameters'):
            ...
            if not os.path.exists(r'{}/log/{}'.format(LOCAL, self.opt.task)):
                os.makedirs(r'{}/log/{}'.format(LOCAL, self.opt.task))
            filename = r'{}/log/{}/{}.txt'.format(LOCAL, self.opt.task, time.strftime("%Y-%m-%d-%H-%M-%S", time.localtime()))
